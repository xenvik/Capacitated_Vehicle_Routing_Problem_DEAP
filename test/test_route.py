...
from deap_model import input_instance, route_subroute, route_cost


# Run test_distance to calculate distance between two clients
class TestRoute(unittest.TestCase):
    ...
    def test_route(self):
        ...
        calculated_subroute = route_subroute(sample_individual, loaded_instance)
    ...
    def test_subroute_distance(self):
        ...
        loaded_instance = input_instance('./data/json/Input_Data.json')
        sample_individual = [19, 5, 24, 7, 16, 23, 22, 2, 12, 8, 20, 25, 21, 18, 11, 15, 1, 14, 17, 6, 4, 13, 10, 3, 9]
        sample_individual_subroutes = route_subroute(sample_individual, loaded_instance)
        ...
        calculated_distance = route_cost(first_subroute, loaded_instance, unit_cost=1)
    ...
    def test_route_distance(self):
        ...
        calculated_distance = route_cost(first_subroute+second_subroute, loaded_instance, unit_cost=1)
